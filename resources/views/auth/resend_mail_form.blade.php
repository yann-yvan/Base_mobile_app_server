...
<div class="wrapper">
    ...
    <div class="box">
        <form action={{url('api/verification/resend')}}
                method="POST" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate">
            {{csrf_token()}}
            <input type="email" value="" name="email" class="email" id="mce-EMAIL"
                   placeholder={{"lovely-human@".str_replace(' ','_',env('APP_NAME')).".com"}} required>
...
<script>
    ...
    function register($form) {
        ...
        $.ajax({
            type: 'POST',
            url: '{{url('api/verification/resend')}}',
            ...
            success: function (data) {
                ...
                if (data.status === 'success') {
                    ...
                    $('#subscribe-result').html('<p>Thank you for. We have sent you a confirmation email.</p>');
                    $('#mce-EMAIL').val('')
                } else {
