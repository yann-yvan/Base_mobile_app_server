...
">
            <img src="{{asset('app_logo.png')}}" width="232" style="	display: block;
	margin: 0 auto;
margin: 30px auto;">
        </td>
    </tr>
...
background: #F4FBF9;">
    ...
    border: none !important;
padding: 20px;">
                        <p class="marginless" style="margin: 0;">Welcome, <br>The {{env('APP_NAME')}} Team</p>
                    </td>
                </tr>
                </tbody>
            </table>
...
">
	...
	vertical-align: top;
    border: none !important;
background: #1FD99A; "><img src="https://carpool-email-assets.s3.amazonaws.com/shared/footer@2x.png" alt="" width="500"
                            class="img_section" style="	display: block;
	margin: 0 auto;
	width: 100%;
	max-width: 500px;
"></td>
...
">
	...
	line-height: 1.5;
">
                            If you did not enter this email address when signing up for {{env('APP_NAME')}} service,
                            disregard this message.<br><br>
                            <br>
                            This is a mandatory service email from {{env('APP_NAME')}}.
                        </p>
                    </td>
                </tr>
                </tbody>
